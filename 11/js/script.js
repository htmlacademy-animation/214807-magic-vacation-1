...
const prizesAnimator = new _prizes_animator__WEBPACK_IMPORTED_MODULE_1__["default"](`.prizes__item`, {timeSteps: [1000, 4000, 2300]});
...
class FullPageScroll {
  ...
  changeVisibilityDisplay() {
    ...
    if (this.activeScreen === 2) {
      _animations__WEBPACK_IMPORTED_MODULE_1__["prizesAnimator"].runAnimation();
    }
